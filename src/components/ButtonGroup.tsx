  ...
  return (
    <div className={`flex items-center gap-4 ${classStyles}`}>
      ...
      <button
        ...
        className='shadown-sm rounded-lg bg-[#4F46E5] px-2 py-1 text-sm font-medium text-white hover:bg-[#392fec] disabled:bg-opacity-50 sm:text-base md:px-4 md:py-2 md:text-lg'
      >
        {button2_text}
      </button>
    </div>
